...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('seller-dashboard') }} ">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'seller-dashboard' ? ' active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'seller-tables' ? ' active bg-gradient-primary' : '' }} "
                   href="{{ route('seller-tables', ['seller_id' => Auth::id()]) }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'seller-notifications' ? ' active bg-gradient-primary' : '' }}  "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'seller-profile' ? ' active bg-gradient-primary' : '' }}  "
