               ...
               <div class="containt_main">
                  ...
                  <div class="main">
                     ...
                     <div class="input-group">
                        ...
                        <div class="input-group-append">
                           <button class="btn btn-secondary" type="button" style="background-color: var(--maincolor); border-color:var(--maincolor) ">
                  ...
                  <div class="header_box">
                     <!-- <div class="lang_box ">
                        ...
                        <img src="{{asset('frontRessource/images/flag-uk.png')}}" alt="flag" class="mr-2 " title="United Kingdom"> English <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                        </a>
                        <div class="dropdown-menu ">
                           <a href="#" class="dropdown-item">
                           <img src="{{asset('frontRessource/images/flag-france.png')}}" class="mr-2" alt="flag">
                           French
                           </a>
                        </div>
                     </div> -->
               ...
               <div id="my_slider" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">Start<br>Your shopping</h1>
                     ...
                     <div class="carousel-item">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">Explore<br>Your Choices</h1>
                              <div class="buynow_bt"><a href="#">Buy Now</a></div>
                           </div>
                        </div>
                     </div>
                     <div class="carousel-item">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">Shopping,<br>made easier</h1>
                              <div class="buynow_bt"><a href="#">Buy Now</a></div>
                           </div>
                        </div>
                     </div>
